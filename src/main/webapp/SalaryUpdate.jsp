...
<head>
  <meta charset="UTF-8">
    ...
    <title> Salary Update- Financial Management System</title>
    <style>
        * {
            margin: 0;
            padding: 0;
 ...
 <div class="header">
    ...
    <div class="container">
        ...
        <div class="main-content">
            <h2 class="page-title">Update Salary Record</h2>
            ...
            <form class="salary-form" action="Update" method="post">
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="number" value="<%=BasicSalary %>"  name="BasicSalary"/>
                        </div>
                        <div class="form-group">
                            <label for="OTRate">OT Rate</label>
                            <input type="number" value="<%=OTRate %>" name="OTRate"/>
                        </div>
                        <div class="form-group">
                            <label for="DeductionRate">Deduction Rate</label>
                            <input type="number" value="<%=DeductionRate %>" name="DeductionRate"/>
                        </div>

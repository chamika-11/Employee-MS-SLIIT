...
<head>
    ...
    <title>Add Salary - Financial Management System</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <a href="addsalary.html" style="background: #34495e;">💰 Add Salary</a>
        ...
        <div class="main-content">
            ...
            <form class="salary-form" action="calculatebonusservlet" method="post">
               ...
               <!--   <div class="form-section">
                    <h3 class="form-section-title">Salary Components</h3>
                    <div class="form-grid">
                        <div class="form-group">
                            <label>Housing Allowance</label>
                            <input type="number" placeholder="Enter housing allowance" name="HAllowance" />
                        </div>
                        <div class="form-group">
                            <label>Transportation Allowance</label>
                            <input type="number" placeholder="Enter transportation allowance" name="TAllowance" />
                        </div>
                        <div class="form-group">
                            <label>Performance Bonus</label>
                            <input type="number" placeholder="Enter performance bonus"  name="PBonus"/>
                        </div>
                        <div class="form-group">
                            <label>OT Hours</label>
                            <input type="number" placeholder="Enter OT hours"  name="OThours"/>
                        </div>
                    </div>
               ...
               <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="number" placeholder="Enter tax deduction" />
                        </div>
                        <div class="form-group">
                            <label>Insurance Premium</label>
                            <input type="number" placeholder="Enter insurance premium" />
                        </div>
                        <div class="form-group">
                            <label>Loan Repayment</label>
                            <input type="number" placeholder="Enter loan repayment amount" />
                        </div>
                        <div class="form-group">
                            <label>Other Deductions</label>
                            <input type="number" placeholder="Enter other deductions" />
                        </div>
                    </div>
                    <div class="action-buttons">
                ...
                <div class="action-buttons">
                    ...
                    <button type="submit" class="btn btn-primary">Total Salary</button>
                </div>-->

                <div class="calculation-summary">
                    <h3 class="form-section-title">Salary Summary</h3>
    ...
    <script>
        // Add your JavaScript for form validation and calculations here
    </script>
</body>
</html>

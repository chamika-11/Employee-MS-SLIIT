...
<body>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <a href="User2.jsp"> Personal Info</a>
            <a href="LeaveApplicationForm.jsp"> Apply For Leave</a>
            <a href="ViewApplicationForm.jsp"> View Leave</a>
    ...
    <script>
        ...
        function renderCalendar() {
            ...
            while (date.isBefore(endDate)) {
                html += `<div class="calendar-date" data-date="${date.format('YYYY-MM-DD')}">${date.date()}</div>`;
                date.add(1, 'day');
            }
            ...
            document.querySelectorAll('.calendar-date').forEach(dayElement => {
                if (dayElement.getAttribute('data-date') === today) {
        ...
        document.getElementById('prevMonth').addEventListener('click', () => {
            ...
            renderCalendar();
            document.getElementById('currentMonth').innerText = currentDate.format('MMMM YYYY');
        });

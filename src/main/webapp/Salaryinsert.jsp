...
<body>
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <form class="salary-form" action="insert" method="post">
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="number" placeholder="Enter basic salary"  name="BasicSalary"/>
                        </div>
                        <div class="form-group">
                            <label for="OTRate">OT Rate</label>
                            <input type="number" placeholder="Enter OT Rate" name="OTRate"/>
                        </div>
                        <div class="form-group">
                            <label for="DeductionRate">Deduction Rate</label>
                            <input type="number" placeholder="Enter Deduction Rate" name="DeductionRate"/>
                        </div>

...
@WebServlet("/B_Update_Employee")
public class B_Update_Employee extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = B_Emp_DbUtil.updateemployee(EmpId, EmpName,DOB,Gender,Email,Contact,Department,Position,Address_L1,Address_L2,Username,Password);
		
		if(isTrue == true) {
			List<B_Employee> empDetails = B_Emp_DbUtil.getUpdatedEmployeeDetails(EmpId);

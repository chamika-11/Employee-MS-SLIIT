...
public class A_ProjectDBUtil {
	...
	public static List<A_Project> validate(String username, String password) {
		
		ArrayList<A_Project> project = new ArrayList<>();
		...
		try {
			...
			if(rs.next()) {
				...
				A_Project p = new A_Project(projectID, projectName, description, clientName, deadline, status, userU, passU);
				project.add(p);
			}
		}
		catch(Exception e) {
	...
	public static List<A_Project> getAllEmployeeDetails() {
		

		
		ArrayList<A_Project> proj = new ArrayList<>();
		...
		try {
			...
			while (rs.next()) {
				...
				A_Project p = new A_Project(projectID, projectName, description, clientName, deadline, status, username, password);
				proj.add(p);	
			}
	...
	//GetAllProject
	public static List<A_Project> getProjectDetails(String PID) {
		
		ArrayList<A_Project> pro = new ArrayList<>();

...
public class EmployeeController {
  ...
  //GetEmployee
    public static List<EmployeeModel> getAllEmployee(String empID){
	
	ArrayList<EmployeeModel> employ = new ArrayList<>();
	try {
    	con=C_DBConnection.getConnection();
    	stmt=con.createStatement();
    	...
    	while(rs.next()) {
    		...
    		EmployeeModel empm=new EmployeeModel(leave_id,employee_id,leave_type,start_date,end_date,reason,approval_status);
    		employ.add(empm);
    	}
